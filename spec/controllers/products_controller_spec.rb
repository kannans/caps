...
describe ProductsController do
  ...
  def valid_attributes
    { :name=>"product1", :price=>"12.2", :description=>"Hi this is description" }    
  end

   context "GET method with Index" do
    before do      
      get :index
    end
    it { should respond_with(:success)}
    #it { should assign_to(:medical_organizations)                  }   Depricated in  2.0
    it { should render_template(:index)}
    it { should_not set_the_flash}
  end

  context  "Get method NEW" do
    before do
      get :new
    end
    it { should respond_with(:success)}
  ...
  context "Post method CREATE with valid params" do
    before do
      post :create, { :product => valid_attributes }
    end    
    it { should respond_with(:redirect)            }
    it { should set_the_flash.to('Product was successfully created.' )      }
  end


  context "Post method CREATE with Invalid params" do
    before do
      post :create, {}
    end
    it { should respond_with(:success)}
  ...
  context "GET edit" do
    before do
      product =  Product.create!(:name=>"apple", :price=>121, :description=>"txt")
  ...
  describe "Put update" do
    ...
    context "with valid params" do
      ...
      it { should respond_with(:redirect)  }  
      it { should set_the_flash.to('Product was successfully updated.' )      }     
    end
  end
